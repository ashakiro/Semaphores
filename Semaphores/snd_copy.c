...
//=============== TRYING_TO_START_WORK ======================================
    ...
    set_sop (sops, 4, SEM_RCV_MUTEX,     1, SEM_UNDO);
    set_sop (sops, 5, SEM_SND_READY, 1,  0);

    if (semop (semid, sops, 6) == -1) return 0;
...
//=============== FINISHING_WORK ============================================
    ...
    set_sop (sops, 3, SEM_SND_ALIVE,  1, 0); //Now it's not important to be alive, because job is done
    semop (semid, sops, 4);
