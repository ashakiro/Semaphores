...
//=============== CREATING_SEMAPHORES_&_SOPS ================================
    ...
    semid = semget (semkey, NSEMS, IPC_CREAT | 0644);
	ASSERT_snd (semid != -1,
                "ERROR: semget failed");
...
//================= SOME_PREPARATIONS =======================================
    ...
    set_sop (sops, 0, SEM_RCV_MUTEX, 1, SEM_UNDO);
    set_sop (sops, 1, SEM_SND_READY, 1, 0);
    semop (semid, sops, 2);
...
//=============== FINISHING_WORK ============================================
    ...
    set_sop (sops, 0, SEM_SND_READY, 1, 0); //Telling reciever, that sender is ready to finish
    semop (semid, sops, 1);
    set_sop (sops, 0, SEM_RCV_READY, -1, 0);//Waiting for the moment, when reciever is ready to finish
    semop (semid, sops, 1);
    semctl (semid, IPC_RMID, 0);*/
